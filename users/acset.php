...
// --- 3. ส่วนเปลี่ยนรหัสผ่าน (เพิ่มการเช็คความยาว 6 ตัวอักษร) ---
if (isset($_POST['change_password'])) {
    ...
    } elseif (mb_strlen($new_pass) < 6) { // เพิ่มการเช็คตรงนี้
        $status_msg = "รหัสผ่านใหม่ต้องมีความยาวอย่างน้อย 6 ตัวอักษรค่ะ";
...
<head>
    ...
    <style>
        ...
        .status-badge {
            ...
            padding: 15px 25px;
            border-radius: 20px;
            border-left: 5px solid var(--mira-pink-accent);
            margin-bottom: 30px;
        }
